...
class Test_dumps:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            [
                3,
                "constraints (primarykey_id INTEGER Key Nullable, notnull_value REAL Nullable, unique_value INTEGER Key Nullable, def_text_value TEXT Nullable, def_num_value INTEGER Nullable)",
            ],
            [
                4,
                dedent(
